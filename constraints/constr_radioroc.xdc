...
connect_debug_port u_ila_0/probe0 [get_nets [list {dataAcqCtrlInst/dataOut[1][0]} {dataAcqCtrlInst/dataOut[1][1]} {dataAcqCtrlInst/dataOut[1][2]} {dataAcqCtrlInst/dataOut[1][3]} {dataAcqCtrlInst/dataOut[1][4]} {dataAcqCtrlInst/dataOut[1][5]} {dataAcqCtrlInst/dataOut[1][6]} {dataAcqCtrlInst/dataOut[1][7]}]]
connect_debug_port u_ila_0/probe1 [get_nets [list {dataAcqCtrlInst/byteCnt[0]} {dataAcqCtrlInst/byteCnt[1]} {dataAcqCtrlInst/byteCnt[2]}]]
connect_debug_port u_ila_0/probe2 [get_nets [list {dataAcqCtrlInst/dataIn[1][0]} {dataAcqCtrlInst/dataIn[1][1]} {dataAcqCtrlInst/dataIn[1][2]} {dataAcqCtrlInst/dataIn[1][3]} {dataAcqCtrlInst/dataIn[1][4]} {dataAcqCtrlInst/dataIn[1][5]} {dataAcqCtrlInst/dataIn[1][6]} {dataAcqCtrlInst/dataIn[1][7]}]]
connect_debug_port u_ila_0/probe3 [get_nets [list {dataAcqCtrlInst/dataIn[2][0]} {dataAcqCtrlInst/dataIn[2][1]} {dataAcqCtrlInst/dataIn[2][2]} {dataAcqCtrlInst/dataIn[2][3]} {dataAcqCtrlInst/dataIn[2][4]} {dataAcqCtrlInst/dataIn[2][5]} {dataAcqCtrlInst/dataIn[2][6]} {dataAcqCtrlInst/dataIn[2][7]}]]
connect_debug_port u_ila_0/probe4 [get_nets [list {dataAcqCtrlInst/dataOut[3][0]} {dataAcqCtrlInst/dataOut[3][1]} {dataAcqCtrlInst/dataOut[3][2]} {dataAcqCtrlInst/dataOut[3][3]} {dataAcqCtrlInst/dataOut[3][4]} {dataAcqCtrlInst/dataOut[3][5]} {dataAcqCtrlInst/dataOut[3][6]} {dataAcqCtrlInst/dataOut[3][7]}]]
connect_debug_port u_ila_0/probe5 [get_nets [list {dataAcqCtrlInst/nbAcqSig[0]} {dataAcqCtrlInst/nbAcqSig[1]} {dataAcqCtrlInst/nbAcqSig[2]} {dataAcqCtrlInst/nbAcqSig[3]} {dataAcqCtrlInst/nbAcqSig[4]} {dataAcqCtrlInst/nbAcqSig[5]} {dataAcqCtrlInst/nbAcqSig[6]} {dataAcqCtrlInst/nbAcqSig[7]}]]
connect_debug_port u_ila_0/probe6 [get_nets [list {dataAcqCtrlInst/dataIn[0][0]} {dataAcqCtrlInst/dataIn[0][1]} {dataAcqCtrlInst/dataIn[0][2]} {dataAcqCtrlInst/dataIn[0][3]} {dataAcqCtrlInst/dataIn[0][4]} {dataAcqCtrlInst/dataIn[0][5]} {dataAcqCtrlInst/dataIn[0][6]} {dataAcqCtrlInst/dataIn[0][7]}]]
connect_debug_port u_ila_0/probe7 [get_nets [list {dataAcqCtrlInst/dataIn[3][0]} {dataAcqCtrlInst/dataIn[3][1]} {dataAcqCtrlInst/dataIn[3][2]} {dataAcqCtrlInst/dataIn[3][3]} {dataAcqCtrlInst/dataIn[3][4]} {dataAcqCtrlInst/dataIn[3][5]} {dataAcqCtrlInst/dataIn[3][6]} {dataAcqCtrlInst/dataIn[3][7]}]]
connect_debug_port u_ila_0/probe8 [get_nets [list {dataAcqCtrlInst/dataOut[0][0]} {dataAcqCtrlInst/dataOut[0][1]} {dataAcqCtrlInst/dataOut[0][2]} {dataAcqCtrlInst/dataOut[0][3]} {dataAcqCtrlInst/dataOut[0][4]} {dataAcqCtrlInst/dataOut[0][5]} {dataAcqCtrlInst/dataOut[0][6]} {dataAcqCtrlInst/dataOut[0][7]}]]
connect_debug_port u_ila_0/probe9 [get_nets [list {dataAcqCtrlInst/state[0]} {dataAcqCtrlInst/state[1]} {dataAcqCtrlInst/state[2]} {dataAcqCtrlInst/state[3]}]]
connect_debug_port u_ila_0/probe10 [get_nets [list {dataAcqCtrlInst/dataOut[2][0]} {dataAcqCtrlInst/dataOut[2][1]} {dataAcqCtrlInst/dataOut[2][2]} {dataAcqCtrlInst/dataOut[2][3]} {dataAcqCtrlInst/dataOut[2][4]} {dataAcqCtrlInst/dataOut[2][5]} {dataAcqCtrlInst/dataOut[2][6]} {dataAcqCtrlInst/dataOut[2][7]}]]
connect_debug_port u_ila_0/probe11 [get_nets [list dataAcqCtrlInst/lastByte]]
connect_debug_port u_ila_0/probe12 [get_nets [list dataAcqCtrlInst/rdAcqSig]]
connect_debug_port u_ila_0/probe13 [get_nets [list dataAcqCtrlInst/readSent]]
connect_debug_port u_ila_0/probe14 [get_nets [list dataAcqCtrlInst/resetAcqSig]]
connect_debug_port u_ila_0/probe16 [get_nets [list dataAcqCtrlInst/swTrg]]
...
connect_debug_port u_ila_0/probe2 [get_nets [list {radInterfInst/radioFSMInst/state[0]} {radInterfInst/radioFSMInst/state[1]} {radInterfInst/radioFSMInst/state[2]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe4 [get_nets [list {i2cDataWrRad[0]} {i2cDataWrRad[1]} {i2cDataWrRad[2]} {i2cDataWrRad[3]} {i2cDataWrRad[4]} {i2cDataWrRad[5]} {i2cDataWrRad[6]} {i2cDataWrRad[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe5]
set_property port_width 8 [get_debug_ports u_ila_0/probe5]
connect_debug_port u_ila_0/probe5 [get_nets [list {i2cDataRdRad[0]} {i2cDataRdRad[1]} {i2cDataRdRad[2]} {i2cDataRdRad[3]} {i2cDataRdRad[4]} {i2cDataRdRad[5]} {i2cDataRdRad[6]} {i2cDataRdRad[7]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe7 [get_nets [list i2cBusyRad]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe8]
set_property port_width 1 [get_debug_ports u_ila_0/probe8]
connect_debug_port u_ila_0/probe8 [get_nets [list i2cEnaRad]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe9]
set_property port_width 1 [get_debug_ports u_ila_0/probe9]
connect_debug_port u_ila_0/probe9 [get_nets [list i2cRwRad]]
